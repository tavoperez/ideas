    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            @if(session()->has('message'))
                <div class="text-center bg-gray-100 rounded-md p-2" style="background-color: rgb(100, 193, 8)">
                    <span class="text-indigo-600 text-xl font-semibold" style="color: white">{{ session('message') }}</span>
                </div>
            @endif
            <div class="overflow-hidden shadow-sm sm:rounded-lg mb-4">
                <div class="p-6 text-gray-900 dark:text-gray-100s space-x-8">
                    ...
                    <a href="{{route('idea.index', ['filtro' => 'mis-ideas'])}}" class="px-4 py-4 bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-500 rounded-md font-semibold text-sm text-gray-700 dark:text-gray-300 uppercase tracking-widest shadow-sm hover:bg-gray-50 dark:hover:bg-gray-700">{{ __('Mis Ideas') }}</a>
                </div>
            </div>
